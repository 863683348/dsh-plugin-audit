...
export class Storage {
  constructor(dataDir) {
    ...
    this.scoresPath = join(this.dir, "scores.json");
  }
  ...
  /** Score-history timelines (one array per repo) for audit_history. */
  loadScores() {
    const raw = this.readJson(this.scoresPath, {});
    return typeof raw === "object" && raw !== null ? raw : {};
  }

  saveScores(history) {
    this.writeJson(this.scoresPath, history);
  }
